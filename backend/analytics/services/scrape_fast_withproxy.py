...
class ScraperConfig:
    ...
    # Multi-part mode: if False, search query first and extract category from redirect URL
    IS_MULTI_PART = True  # If False, search query and extract category from auto-redirect
